...
function CryptoContext({children}) {
    ...
    // this is update the watchlist , setWatchlist
    useEffect(() => {
      if (user) {
    ...
    useEffect(() => {
        ...
        // this method handles the state change of the firebase user
        // and returs a call back if the user is logged in or not
